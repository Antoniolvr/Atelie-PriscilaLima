...
const PRODUCTS = [
  ...
  {
    id: 16,
    sku: 'CAMINHO-MESA-016',
    name: 'Caminho de Mesa Azul Serenity com Dourado',
    cat: 'decoracao',
    price: 60.00,
            ...
            : `
              <div class="price-focus-box" style="flex: 1; min-width: 100%;">
                ...
                <div style="margin-top:.6rem">
                  <div style="font-size:1.25rem;font-weight:800;color:#2E7D32;display:flex;align-items:center;gap:.4rem;">
